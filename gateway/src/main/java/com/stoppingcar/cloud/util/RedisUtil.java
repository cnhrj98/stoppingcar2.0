...
public class RedisUtil {
     ...
     */
    public List<String> getAllKey(String patternKey) {
     ...
     * @param time    过期时间
     */
    public void hSet(String key, String hashKey, String value, long time) {
     ...
     * @return
     */
    public String lGetByIndex(String key, long index) {
        try {
     ...
     * @param time  过期时间
     */
    public void rSet(String key, String value, long time) {
        redisTemplate.opsForList().rightPush(key, value);
        expire(key, time);
    }
     ...
     * @param list 要放入缓存的集合
     */
    public void rSet(String key, List<String> list) {
     ...
     * @param time 过期时间
     */
    public void lSet(String key, List<String> list, long time) {
        redisTemplate.opsForList().leftPushAll(key, list);
        expire(key, time);
    }
     ...
     * @param time 过期时间
     */
    public void rSet(String key, List<String> list, long time) {
        redisTemplate.opsForList().rightPushAll(key, list);
        expire(key, time);
    }
